set -x
gfortran -std=legacy -fbounds-check -all_load -w -o zchex-mac-gfort.exe zchex.for zpass1.for zpass2.for zutilty_sub.for zdaniel_new.for zvaxutl.for zerr_suite.for dan_iod77.for
gfortran -std=legacy -fbounds-check -all_load -w -o danlo-mac-gfort.exe danlo.for
gfortran -std=legacy -fbounds-check -all_load -w -o zorder-mac-gfort.exe zorder.for zvaxutl.for zutilty_order.for
